...
#define EXPECTEQUAL(aExpected, aActual) (Hegemonic::Expects::expectEqual(aExpected==aActual, __FILE__, __LINE__));
#define EXPECTNOTEQUA(aExpected, aActual) (Hegemonic::Expects::expectNotEqual(aExpected==aActual, __FILE__, __LINE__));
#define EXPECTFLOATAPPROX(aExpected, aActual) (Hegemonic::Expects::expectFloatApprox(aExpected, aActual, __FILE__, __LINE__));
